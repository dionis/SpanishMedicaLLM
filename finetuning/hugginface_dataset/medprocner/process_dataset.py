...
URL = 'https://zenodo.org/api/records/7886453/files-archive'

FILE_ZIP =  str(path) + os.sep + "MedProcNER.zip"
FILE_ZIP_EXTRAC =  str(path) + os.sep + "MedProcNER"

if not os.path.exists( FILE_ZIP ):
   response = request.urlretrieve(URL,  str(path) + os.sep + "MedProcNER.zip")
